...
<div class="container">
    ...
    <form method="post" name="tcredit" class="tabletext" ><br>
        ...
        <br><br><br>
        <label style="color : black;"><b>Enter the name to Transfer Amount:</b></label>
        ...
        <div class="text-center" >
            <button class="btn mt-3" name="submit" type="submit" id="myBtn"  > Are You Sure to Transfer</button>
        </div>
    </form>
</div>
<footer class="text-center mt-5 py-2">
    <p>@copy 2021. Made by <b>RAMYABL@2000</b> <br> spark Foundation</p>
</footer>
